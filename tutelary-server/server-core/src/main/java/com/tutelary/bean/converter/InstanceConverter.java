...
public interface InstanceConverter extends DomainResponseConverter<Instance, InstanceInfoResponse>,
    PageQueryConverter<InstancePageQueryRequest, InstanceQuery>,
    QueryConverter<InstanceQueryRequest, InstanceQuery> {
