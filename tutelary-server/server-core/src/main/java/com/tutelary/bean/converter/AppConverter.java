...
public interface AppConverter extends DomainResponseConverter<App, AppInfoResponse>,
    PageQueryConverter<AppPageQueryRequest, AppQuery>,
    QueryConverter<AppQueryRequest, AppQuery> {
