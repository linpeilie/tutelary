...
import com.tutelary.message.command.Overview;
...
public class OverviewCommand implements Command<Overview> {
    ...
    private static final Log LOG = LogFactory.get(OverviewCommand.class);
    ...
    public Overview execute() {
        ...
        overview.setHostInfo(getHostInfo());
        overview.setJvmInfo(getJvmInfo());
        overview.setThreadInfo(getThreadOverview());
        overview.setHeapMemory(getJvmMemoryInfo(MemoryType.HEAP));
        overview.setNonHeapMemory(getJvmMemoryInfo(MemoryType.NON_HEAP));
        overview.setGarbageCollectors(getGarbageCollectors());
        return overview;
    }
    ...
    private ThreadOverview getThreadOverview() {
    ...
    private List<JvmMemory> getJvmMemoryInfo(MemoryType memoryType) {
    ...
    private List<GarbageCollector> getGarbageCollectors() {
